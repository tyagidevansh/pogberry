...
static void runtimeError(const char* format, ...) { //variadic function
  va_list args;
...
InterpretResult interpret(const char* source) {
  Chunk chunk; // this empty chunk will be filled by the compiler as it translates tokens to bytecode
  initChunk(&chunk);
